...
## Environments
- Preview: https://main--adapt2--jckautzmann.aem.page/
- Live: https://main--adapt2--jckautzmann.aem.live/
...
1. Open the `adapt2` directory in your favorite IDE and start coding :)
